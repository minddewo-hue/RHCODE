...
export const chatScreenStyles = createThemedStyles((colors) => ({
  ...
  conversationNavigation: { position: "absolute", right: 12, bottom: 12, alignItems: "flex-end", gap: 8 },
  turnNavigation: { height: 42, flexDirection: "row", alignItems: "center", overflow: "hidden", borderWidth: 1, borderColor: colors.border, borderRadius: 21, backgroundColor: colors.surface, shadowColor: colors.shadow, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.14, shadowRadius: 8, elevation: 4 },
  turnNavigationButton: { width: 44, height: 42, alignItems: "center", justifyContent: "center" },
  turnNavigationText: { minWidth: 42, color: colors.inkMuted, fontSize: 11, lineHeight: 15, textAlign: "center", fontVariant: ["tabular-nums"] },
  latestButton: { minHeight: 46, flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 16, borderRadius: 23, backgroundColor: colors.solid, shadowColor: colors.shadow, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 5 },
  latestButtonPressed: { opacity: 0.8 },
  latestButtonText: { color: colors.onSolid, fontSize: 12, lineHeight: 17, fontWeight: "600" },
