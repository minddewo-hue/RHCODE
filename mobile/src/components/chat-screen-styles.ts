...
export const chatScreenStyles = createThemedStyles((colors) => ({
  ...
  latestButton: { position: "absolute", right: 12, bottom: 12, width: 40, height: 40, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.borderStrong, borderRadius: 20, backgroundColor: colors.surface, shadowColor: colors.shadow, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.14, shadowRadius: 8, elevation: 4 },
  latestButtonPressed: { backgroundColor: colors.pressed },
  latestBadge: { position: "absolute", top: -5, right: -5, minWidth: 18, height: 18, paddingHorizontal: 4, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: colors.canvas, borderRadius: 9, backgroundColor: colors.accent },
  latestBadgeText: { color: colors.inverse, fontSize: 9, lineHeight: 11, fontWeight: "700", letterSpacing: 0, fontVariant: ["tabular-nums"] },
  outlineModalRoot: { flex: 1, flexDirection: "row", justifyContent: "flex-end", backgroundColor: colors.overlay },
  outlineScrim: { flex: 1 },
  outlineSheet: { width: "84%", maxWidth: 320, backgroundColor: colors.sidebar, borderLeftWidth: StyleSheet.hairlineWidth, borderLeftColor: colors.border, shadowColor: colors.shadow, shadowOffset: { width: -4, height: 0 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 12 },
  outlineHeader: { height: 56, paddingLeft: 16, paddingRight: 9, flexDirection: "row", alignItems: "center" },
  outlineHeaderText: { flex: 1, minWidth: 0 },
  outlineTitle: { color: colors.ink, fontSize: 15, lineHeight: 20, fontWeight: "600", letterSpacing: 0 },
  outlineCount: { color: colors.inkMuted, fontSize: 10, lineHeight: 14, marginTop: 1, letterSpacing: 0 },
  outlineClose: { width: 40, height: 40, borderRadius: 6, alignItems: "center", justifyContent: "center" },
  outlineSearch: { height: 40, marginHorizontal: 14, marginBottom: 8, paddingHorizontal: 10, borderWidth: 1, borderColor: colors.border, borderRadius: 7, flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: colors.surface },
  outlineSearchInput: { flex: 1, minWidth: 0, height: 38, paddingVertical: 0, color: colors.ink, fontSize: 12, letterSpacing: 0 },
  outlineListView: { flex: 1 },
  outlineList: { paddingHorizontal: 10, paddingBottom: 12 },
  outlineRow: { position: "relative", height: 70, paddingHorizontal: 9, paddingVertical: 10, borderRadius: 6, flexDirection: "row", alignItems: "flex-start" },
  outlineRowCurrent: { backgroundColor: colors.accentSoft },
  outlineRowPressed: { backgroundColor: colors.pressed },
  outlineMarker: { position: "absolute", top: 9, bottom: 9, left: 0, width: 2, borderRadius: 1, backgroundColor: "transparent" },
  outlineMarkerCurrent: { backgroundColor: colors.accent },
  outlineIndex: { width: 31, paddingTop: 1, color: colors.inkFaint, fontSize: 10, lineHeight: 15, letterSpacing: 0, fontVariant: ["tabular-nums"] },
  outlineIndexCurrent: { color: colors.accent, fontWeight: "600" },
  outlineRowBody: { flex: 1, minWidth: 0 },
  outlineSummary: { color: colors.ink, fontSize: 12, lineHeight: 17, fontWeight: "500", letterSpacing: 0 },
  outlineSummaryCurrent: { color: colors.accent, fontWeight: "600" },
  outlineTime: { color: colors.inkFaint, fontSize: 9, lineHeight: 13, marginTop: 3, letterSpacing: 0 },
  outlineEmpty: { paddingVertical: 36, color: colors.inkMuted, fontSize: 12, lineHeight: 17, textAlign: "center", letterSpacing: 0 },
